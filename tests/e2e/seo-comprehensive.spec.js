...
const PAGES = [
  {
    ...
    h1: true,
    schemaTypes: ['Organization', 'FAQPage', 'LocalBusiness', 'BreadcrumbList'],
  ...
  {
    path: '/blog/service-area-melbourne-cbd',
    name: 'blog-post-service-area',
    titleContains: 'Melbourne CBD',
    h1: true,
    schemaTypes: ['BlogPosting', 'BreadcrumbList'],
    bodyContainsAny: ['Melbourne', 'AI'],
  },
  {
